...
public class ViewDirectorio {
	...
	private void initialize() {
		...
		JButton btnActualizarContactos = new JButton("Actualizar Contactos",new ImageIcon("./src/main/img/Refresh.png"));
		...
		btnApagarDirectorio.addActionListener(new ActionListener() {
